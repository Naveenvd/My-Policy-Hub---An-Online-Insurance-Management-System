...
<body>
  ...
  <main>
    <form action="AdminInsurancePlansServlet" method="GET" class="dashboard-card life-insurance">
    ...
    <form action="AdminInsurancePlansServlet" method="GET" class="dashboard-card health-insurance">
    ...
    <form action="AdminInsurancePlansServlet" method="GET" class="dashboard-card vehicle-insurance">
    ...
    <form action="AdminInsurancePlansServlet" method="GET" class="dashboard-card home-insurance">
